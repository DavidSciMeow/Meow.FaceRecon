namespace Meow.FaceRecon
{
    ...
    public enum APIResult
    {
        ...
        /// </summary>
        MERR_ASF_LOCAL_TIME_NOT_CALIBRATED = (MERR_ASF_BASE_EXTEND + 6),
        ...
        /// </summary>
        MERR_ASF_DETECT_MODEL_UNSUPPORTED = (MERR_ASF_BASE_EXTEND + 11),

        /// <summary>
        /// 当前设备时间不正确，请调整设备时间
        /// </summary>
        MERR_ASF_CURRENT_DEVICE_TIME_INCORRECT = (MERR_ASF_BASE_EXTEND + 12),

        /// <summary>
        /// 年度激活数量超出限制，次年清零
        /// </summary>
        MERR_ASF_ACTIVATION_QUANTITY_OUT_OF_LIMIT = (MERR_ASF_BASE_EXTEND + 13),

        /// <summary>
        /// 频繁请求，4小时后解禁
        /// </summary>
        MERR_ASF_IP_BLACK_LIST = (MERR_ASF_BASE_EXTEND + 14),
